...
disease=['Fungal infection','Allergy','GERD','Chronic cholestasis','Drug Reaction',
        ...
        'Hypothyroidism','Hyperthyroidism','Hypoglycemia','Osteoarthristis','Arthritis','(vertigo) Paroymsal  Positional Vertigo',
...
def message():
    if (Symptom1.get() == "None" and  Symptom2.get() == "None" and Symptom3.get() == "None" and Symptom4.get() == "None" and Symptom5.get() == "None"):
        messagebox.showinfo("Alert", "ENTER  SYMPTOMS PLEASE")
    else :
        NaiveBayes()
...
title=Label(root,justify=CENTER,text="DISEASE PREDICTION SYSTEM",
            fg="white",bg="#32428A", bd=12,pady=2,relief=GROOVE)
title.config(font=('arial',30,'bold'))
title.grid(row=1, column=1, columnspan=2, padx=100)

NameLb1 = Label(root, text="")
NameLb1.config(font=('arial',18,'bold'))
NameLb1.grid(row=5, column=1, pady=10,  sticky=W)

S1Lb = Label(root,  text="Symptom 1")
S1Lb.config(font=('arial',18,'bold'))
S1Lb.grid(row=7, column=1, pady=10 , sticky=W)

S2Lb = Label(root,  text="Symptom 2")
S2Lb.config(font=('arial',18,'bold'))
S2Lb.grid(row=8, column=1, pady=10, sticky=W)

S3Lb = Label(root,  text="Symptom 3")
S3Lb.config(font=('arial',18,'bold'))
S3Lb.grid(row=9, column=1, pady=10, sticky=W)

S4Lb = Label(root,  text="Symptom 4")
S4Lb.config(font=('arial',18,'bold'))
S4Lb.grid(row=10, column=1, pady=10, sticky=W)

S5Lb = Label(root,  text="Symptom 5")
S5Lb.config(font=('arial',18,'bold'))
S5Lb.grid(row=11, column=1, pady=20, sticky=W)
...
lr = Button(root, text="Predict", height=2, width=20, command=message,
            bd=4,bg="#07958F",fg="white")
lr.config(font=('arial',18,'bold'))
lr.grid(row=15, column=1,pady=30)
